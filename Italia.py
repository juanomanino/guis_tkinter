...
frame_entrada.config(bg="sea green", width=260, height=480)
...
frame_operaciones.config(bg="white", width=260, height=480)
...
frame_resultados.config(bg="firebrick2", width=260, height=480)
